// this file consists of helper functions used by the React components
...
// dynamically determines backend API URL based on development environment (URLs set in .env)
export function getAPIDomain() {
    return process.env.NODE_ENV === 'production' ? process.env.REACT_APP_API_PROD_DOMAIN : process.env.REACT_APP_API_DEV_DOMAIN;
}